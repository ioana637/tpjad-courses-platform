...
import { coursesGetAll, coursesAddEdit, coursesSendNewsToStudents, coursesFilter, coursesMy, coursesDeleteAndGetById, coursesEnroll, coursesStudentsForCourse, coursesNumberStudents, coursesLeave } from './urls';
...
export class CoursesService {
  ...
  leaveCourse(courseId: number) {
    return this.http.post(coursesLeave(courseId.toString()), null, { headers: this.httpHeaders });
  }
